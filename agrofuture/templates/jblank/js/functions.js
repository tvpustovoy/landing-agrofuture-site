        ...
        if ( change_background != false && change_bg_check() ){
            ...
            if (section_custom_background !== undefined && section_custom_background != "")
            {
                ...
                $(function() {
                  ...
                  if (overlay_enabled) $.vegas('overlay', { src:'/templates/jblank/images/background-image-overlay-full.png', opacity:overlay_opacity });
                });
            }
 ...
 function validate_fields(form_object, single_field)
 {
    ...
    if (form_object !== undefined && form_object.length > 0)
    {
        ...
        form_fields_to_validate.each(function()
        {
            ...
            if (field_required == true && (field_value == "" || field_value === null || field_value === undefined)) single_field_error_details["message"] = "Это обязательное поле";

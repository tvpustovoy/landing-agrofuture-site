...
--
-- Хост: localhost
-- Время создания: Сен 24 2015 г., 14:06
...
--
-- База данных: `u0081082_agrof`
--

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_assets`
--

CREATE TABLE IF NOT EXISTS `agrf_assets` (
...
--
-- Дамп данных таблицы `agrf_assets`
--

INSERT INTO `agrf_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(54, 18, 70, 71, 2, 'com_modules.module.87', 'Левый Сайдбар', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(55, 18, 72, 73, 2, 'com_modules.module.88', 'Футер', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(56, 18, 74, 75, 2, 'com_modules.module.89', 'Первый текст (intro)', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(57, 18, 76, 77, 2, 'com_modules.module.90', 'О проекте', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(58, 18, 78, 79, 2, 'com_modules.module.91', 'Кто мы', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(59, 18, 80, 81, 2, 'com_modules.module.92', 'Партеры', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(60, 18, 82, 83, 2, 'com_modules.module.93', 'Связаться с нами', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}');

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_associations`
--

CREATE TABLE IF NOT EXISTS `agrf_associations` (
...
--
-- Структура таблицы `agrf_banners`
--

CREATE TABLE IF NOT EXISTS `agrf_banners` (
...
--
-- Структура таблицы `agrf_banner_clients`
--

CREATE TABLE IF NOT EXISTS `agrf_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `agrf_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `agrf_banner_tracks` (
...
--
-- Структура таблицы `agrf_categories`
--

CREATE TABLE IF NOT EXISTS `agrf_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `agrf_categories`
--

INSERT INTO `agrf_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Структура таблицы `agrf_contact_details`
--

CREATE TABLE IF NOT EXISTS `agrf_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `agrf_content`
--

CREATE TABLE IF NOT EXISTS `agrf_content` (
...
--
-- Структура таблицы `agrf_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `agrf_contentitem_tag_map` (
...
--
-- Структура таблицы `agrf_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `agrf_content_frontpage` (
...
--
-- Структура таблицы `agrf_content_rating`
--

CREATE TABLE IF NOT EXISTS `agrf_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `agrf_content_types`
--

CREATE TABLE IF NOT EXISTS `agrf_content_types` (
...
--
-- Дамп данных таблицы `agrf_content_types`
--

INSERT INTO `agrf_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `agrf_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `agrf_core_log_searches` (
...
--
-- Структура таблицы `agrf_extensions`
--

CREATE TABLE IF NOT EXISTS `agrf_extensions` (
...
--
-- Дамп данных таблицы `agrf_extensions`
--

INSERT INTO `agrf_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"95d55d9474d303c972bed0699ed7f341"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `agrf_finder_links`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links` (
...
--
-- Структура таблицы `agrf_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms0` (
...
--
-- Структура таблицы `agrf_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `agrf_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `agrf_finder_taxonomy`
--

INSERT INTO `agrf_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `agrf_finder_terms`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_terms` (
...
--
-- Структура таблицы `agrf_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `agrf_finder_terms_common`
--

INSERT INTO `agrf_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `agrf_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `agrf_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `agrf_finder_types`
--

CREATE TABLE IF NOT EXISTS `agrf_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `agrf_languages`
--

CREATE TABLE IF NOT EXISTS `agrf_languages` (
...
--
-- Дамп данных таблицы `agrf_languages`
--

INSERT INTO `agrf_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_menu`
--

CREATE TABLE IF NOT EXISTS `agrf_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `agrf_menu`
--

INSERT INTO `agrf_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Дамп данных таблицы `agrf_menu_types`
--

INSERT INTO `agrf_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_messages`
--

CREATE TABLE IF NOT EXISTS `agrf_messages` (
...
--
-- Структура таблицы `agrf_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `agrf_messages_cfg` (
...
--
-- Структура таблицы `agrf_modules`
--

CREATE TABLE IF NOT EXISTS `agrf_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `agrf_modules`
--

INSERT INTO `agrf_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Дамп данных таблицы `agrf_modules_menu`
--

INSERT INTO `agrf_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `agrf_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `agrf_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `agrf_overrider`
--

CREATE TABLE IF NOT EXISTS `agrf_overrider` (
...
--
-- Структура таблицы `agrf_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `agrf_postinstall_messages` (
...
--
-- Дамп данных таблицы `agrf_postinstall_messages`
--

INSERT INTO `agrf_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `agrf_redirect_links`
--

CREATE TABLE IF NOT EXISTS `agrf_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `agrf_schemas`
--

CREATE TABLE IF NOT EXISTS `agrf_schemas` (
...
--
-- Дамп данных таблицы `agrf_schemas`
--

INSERT INTO `agrf_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_session`
--

CREATE TABLE IF NOT EXISTS `agrf_session` (
...
--
-- Дамп данных таблицы `agrf_session`
--

INSERT INTO `agrf_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('10e4de52a422220848bc725027e20976', 0, 1, '1443092264', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1443092264;s:18:"session.timer.last";i:1443092264;s:17:"session.timer.now";i:1443092264;s:24:"session.client.forwarded";s:12:"128.30.52.73";s:22:"session.client.browser";s:48:"Validator.nu/LV http://validator.w3.org/services";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('15d0f30bdea1c669a992fca32f171e56', 0, 1, '1443092591', '__default|a:8:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1443092591;s:18:"session.timer.last";i:1443092591;s:17:"session.timer.now";i:1443092591;s:24:"session.client.forwarded";s:15:"213.179.228.139";s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.99 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('1a56ce84d0838aa08760ec1f62503efb', 1, 0, '1443092691', '__default|a:9:{s:15:"session.counter";i:72;s:19:"session.timer.start";i:1443089292;s:18:"session.timer.last";i:1443092691;s:17:"session.timer.now";i:1443092691;s:24:"session.client.forwarded";s:15:"213.179.228.139";s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.99 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":4:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:10:"com_config";O:8:"stdClass":1:{s:6:"config";O:8:"stdClass":1:{s:6:"global";O:8:"stdClass":1:{s:4:"data";a:91:{s:7:"offline";s:1:"0";s:15:"offline_message";s:129:"Сайт закрыт на техническое обслуживание.<br />Пожалуйста, зайдите позже.";s:23:"display_offline_message";s:1:"1";s:13:"offline_image";s:0:"";s:8:"sitename";s:50:"Лига инициативных аграриев";s:6:"editor";s:4:"none";s:7:"captcha";s:1:"0";s:10:"list_limit";s:2:"20";s:6:"access";s:1:"1";s:5:"debug";s:1:"0";s:10:"debug_lang";s:1:"0";s:6:"dbtype";s:6:"mysqli";s:4:"host";s:9:"localhost";s:4:"user";s:14:"u0081082_agrof";s:8:"password";s:12:"$hV@!l(X[HB8";s:2:"db";s:14:"u0081082_agrof";s:8:"dbprefix";s:5:"agrf_";s:9:"live_site";s:0:"";s:6:"secret";s:16:"DnjpQG7sqN3VMJwf";s:4:"gzip";s:1:"0";s:15:"error_reporting";s:7:"default";s:7:"helpurl";s:90:"https://help.joomla.org/proxy/index.php?option=com_help&keyref=Help{major}{minor}:{keyref}";s:8:"ftp_host";s:0:"";s:8:"ftp_port";s:0:"";s:8:"ftp_user";s:0:"";s:8:"ftp_pass";s:0:"";s:8:"ftp_root";s:0:"";s:10:"ftp_enable";s:1:"0";s:6:"offset";s:3:"UTC";s:10:"mailonline";s:1:"1";s:6:"mailer";s:4:"mail";s:8:"mailfrom";s:12:"reg@lubus.ru";s:8:"fromname";s:50:"Лига инициативных аграриев";s:8:"sendmail";s:18:"/usr/sbin/sendmail";s:8:"smtpauth";s:1:"0";s:8:"smtpuser";s:0:"";s:8:"smtppass";s:0:"";s:8:"smtphost";s:9:"localhost";s:10:"smtpsecure";s:4:"none";s:8:"smtpport";s:2:"25";s:7:"caching";s:1:"0";s:13:"cache_handler";s:4:"file";s:9:"cachetime";s:2:"15";s:8:"MetaDesc";s:0:"";s:8:"MetaKeys";s:0:"";s:9:"MetaTitle";s:1:"1";s:10:"MetaAuthor";s:1:"1";s:11:"MetaVersion";s:1:"0";s:6:"robots";s:0:"";s:3:"sef";s:1:"1";s:11:"sef_rewrite";s:1:"0";s:10:"sef_suffix";s:1:"0";s:12:"unicodeslugs";s:1:"0";s:10:"feed_limit";s:2:"10";s:8:"log_path";s:58:"/var/www/u0081082/public_html/agrofuture.brandlord.ru/logs";s:8:"tmp_path";s:57:"/var/www/u0081082/public_html/agrofuture.brandlord.ru/tmp";s:8:"lifetime";s:2:"15";s:15:"session_handler";s:8:"database";s:16:"memcache_persist";s:1:"1";s:17:"memcache_compress";s:1:"0";s:20:"memcache_server_host";s:9:"localhost";s:20:"memcache_server_port";s:5:"11211";s:17:"memcached_persist";s:1:"1";s:18:"memcached_compress";s:1:"0";s:21:"memcached_server_host";s:9:"localhost";s:21:"memcached_server_port";s:5:"11211";s:13:"redis_persist";s:1:"1";s:17:"redis_server_host";s:9:"localhost";s:17:"redis_server_port";s:4:"6379";s:17:"redis_server_auth";s:0:"";s:15:"redis_server_db";s:1:"0";s:12:"proxy_enable";s:1:"0";s:10:"proxy_host";s:0:"";s:10:"proxy_port";s:0:"";s:10:"proxy_user";s:0:"";s:10:"proxy_pass";s:0:"";s:11:"massmailoff";s:1:"0";s:10:"MetaRights";s:0:"";s:19:"sitename_pagetitles";s:1:"0";s:9:"force_ssl";s:1:"0";s:28:"session_memcache_server_host";s:9:"localhost";s:28:"session_memcache_server_port";s:5:"11211";s:29:"session_memcached_server_host";s:9:"localhost";s:29:"session_memcached_server_port";s:5:"11211";s:12:"frontediting";s:1:"1";s:10:"feed_email";s:6:"author";s:13:"cookie_domain";s:0:"";s:11:"cookie_path";s:0:"";s:8:"asset_id";i:1;s:7:"filters";a:9:{i:1;a:3:{s:11:"filter_type";s:2:"NH";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:9;a:3:{s:11:"filter_type";s:2:"BL";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:6;a:3:{s:11:"filter_type";s:2:"BL";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:7;a:3:{s:11:"filter_type";s:4:"NONE";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:2;a:3:{s:11:"filter_type";s:2:"NH";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:3;a:3:{s:11:"filter_type";s:2:"BL";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:4;a:3:{s:11:"filter_type";s:2:"BL";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:5;a:3:{s:11:"filter_type";s:2:"BL";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}i:8;a:3:{s:11:"filter_type";s:4:"NONE";s:11:"filter_tags";s:0:"";s:17:"filter_attributes";s:0:"";}}s:5:"rules";a:10:{s:15:"core.login.site";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:1:"1";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:16:"core.login.admin";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:18:"core.login.offline";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:10:"core.admin";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:0:"";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:1:"1";}s:11:"core.manage";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:0:"";i:7;s:1:"1";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:11:"core.create";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:1:"1";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:11:"core.delete";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}s:9:"core.edit";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:1:"1";i:5;s:0:"";i:8;s:0:"";}s:15:"core.edit.state";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:1:"1";i:8;s:0:"";}s:13:"core.edit.own";a:9:{i:1;s:0:"";i:9;s:0:"";i:6;s:1:"1";i:7;s:0:"";i:2;s:0:"";i:3;s:1:"1";i:4;s:0:"";i:5;s:0:"";i:8;s:0:"";}}}}}}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"160";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:12:"reg@lubus.ru";s:8:"password";s:60:"$2y$10$Jn7CKyaR2EYEbPK66o4xWuQOHOir0u7mNHFA4C2arqyvE6BVYvLba";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-09-22 08:27:46";s:13:"lastvisitDate";s:19:"2015-09-24 07:54:25";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"c766ddf26004f556e0b6e74b4309eab2";}', 160, 'admin'),
('387ac1608b6e8e055170d34b96b44e14', 0, 1, '1443092107', '__default|a:8:{s:15:"session.counter";i:3;s:19:"session.timer.start";i:1443091488;s:18:"session.timer.last";i:1443092066;s:17:"session.timer.now";i:1443092107;s:24:"session.client.forwarded";s:12:"128.30.52.96";s:22:"session.client.browser";s:48:"Validator.nu/LV http://validator.w3.org/services";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('57c3d6a4a326e5c49317cf72ac675983', 0, 1, '1443092649', '__default|a:8:{s:15:"session.counter";i:3;s:19:"session.timer.start";i:1443092508;s:18:"session.timer.last";i:1443092610;s:17:"session.timer.now";i:1443092649;s:24:"session.client.forwarded";s:12:"128.30.52.71";s:22:"session.client.browser";s:48:"Validator.nu/LV http://validator.w3.org/services";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('78fda24e27886a4b817de936ac63ea90', 0, 1, '1443092507', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1443092507;s:18:"session.timer.last";i:1443092507;s:17:"session.timer.now";i:1443092507;s:24:"session.client.forwarded";s:12:"128.30.52.71";s:22:"session.client.browser";s:50:"W3C_Validator/1.3 http://validator.w3.org/services";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_tags`
--

CREATE TABLE IF NOT EXISTS `agrf_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `agrf_tags`
--

INSERT INTO `agrf_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Структура таблицы `agrf_template_styles`
--

CREATE TABLE IF NOT EXISTS `agrf_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `agrf_template_styles`
--

INSERT INTO `agrf_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'jblank', 0, '1', 'J!Blank - Default', '{"less_processor":"gpeasy"}');

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_ucm_base`
--

CREATE TABLE IF NOT EXISTS `agrf_ucm_base` (
...
--
-- Структура таблицы `agrf_ucm_content`
--

CREATE TABLE IF NOT EXISTS `agrf_ucm_content` (
...
--
-- Структура таблицы `agrf_ucm_history`
--

CREATE TABLE IF NOT EXISTS `agrf_ucm_history` (
...
--
-- Структура таблицы `agrf_updates`
--

CREATE TABLE IF NOT EXISTS `agrf_updates` (
...
--
-- Структура таблицы `agrf_update_sites`
--

CREATE TABLE IF NOT EXISTS `agrf_update_sites` (
...
--
-- Дамп данных таблицы `agrf_update_sites`
--

INSERT INTO `agrf_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1443089856, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1443089856, ''),
...
--
-- Структура таблицы `agrf_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `agrf_update_sites_extensions` (
...
--
-- Дамп данных таблицы `agrf_update_sites_extensions`
--

INSERT INTO `agrf_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Структура таблицы `agrf_usergroups`
--

CREATE TABLE IF NOT EXISTS `agrf_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `agrf_usergroups`
--

INSERT INTO `agrf_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `agrf_users`
--

CREATE TABLE IF NOT EXISTS `agrf_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `agrf_users`
--

INSERT INTO `agrf_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(160, 'Super User', 'admin', 'reg@lubus.ru', '$2y$10$Jn7CKyaR2EYEbPK66o4xWuQOHOir0u7mNHFA4C2arqyvE6BVYvLba', 0, 1, '2015-09-22 08:27:46', '2015-09-24 10:08:18', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_user_keys`
--

CREATE TABLE IF NOT EXISTS `agrf_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `agrf_user_notes`
--

CREATE TABLE IF NOT EXISTS `agrf_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `agrf_user_profiles`
--

CREATE TABLE IF NOT EXISTS `agrf_user_profiles` (
...
--
-- Структура таблицы `agrf_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `agrf_user_usergroup_map` (
...
--
-- Дамп данных таблицы `agrf_user_usergroup_map`
--

INSERT INTO `agrf_user_usergroup_map` (`user_id`, `group_id`) VALUES
(160, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `agrf_viewlevels`
--

CREATE TABLE IF NOT EXISTS `agrf_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `agrf_viewlevels`
--

INSERT INTO `agrf_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
